...
# It contains pretty much the minimal changes and has not yet been cleaned in any way.
...
function install_fbcp() {
    ...
    cmake -DADAFRUIT_ILI9341_PITFT=ON -DSPI_BUS_CLOCK_DIVISOR=30 ..  1> /dev/null  || { warning "Failed to cmake fbcp!" && exit 1; }
